       ...
       foreach(chitiettour::where('MaTour',$matour)-> where('NgayKhoiHanh','>',date(now()))->get() as $ct){
                 echo'<tr>
                          ...
                          if( $ct-> LichTrinh != null){
                            echo '<a href="employee/PDF/InLT/'. $ct-> LichTrinh .'">In Lịch trình tour </a>';
                          }
                            ...
                            <td>';
                              ...
                              echo '<a href="employee/qlHD/ListHDTour/'.$ct -> MaCTTour.'" class="btn btn-info btn-fw" style="width: 150px;" >List Hợp Đồng</a>';
                              }
                              echo '<a href="employee/qlTour/DSKhachDi/'.$ct -> MaCTTour.'" class="btn btn-secondary btn-fw" style="width: 150px;" >List Lữ Khách</a>
                              <br>
