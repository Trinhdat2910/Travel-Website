...
class BlogNVController extends Controller
{
    
     public function getDSBlog(){
     	$blog= blog::where('TrangThai', 1)->get();
    	return view('employee.qlBlog.danhsachBlog',[ 'blog'=>$blog]);
    }
    ...
    public function getAddBlog(){
    	return view('employee.qlBlog.themBlog');
    }
    ...
    public function getEditBlog($MaBlog){
    	$blog= blog::find($MaBlog);
    	return view('employee.qlBlog.suaBlog', [ 'blog'=>$blog]);
    }
    public function getchitietBlog($MaBlog){
    	$blog= blog::find($MaBlog);
    	return view('employee.qlBlog.chitietBlog', [ 'blog'=>$blog]);
    }
