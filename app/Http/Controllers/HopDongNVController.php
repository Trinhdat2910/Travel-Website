...
class HopDongNVController extends Controller
{
    public function getDanhSachHD(){
        $hopdong = hopdong::join('chitiettour','chitiettour.MaCTTour','=','hopdong.MaCTTour')->join('tour','tour.MaTour','=','chitiettour.MaTour')->where('tour.MaNV',Auth::id())->get();
        return view('employee.qlHD.danhsach',['hopdong'=>$hopdong]);
    }
    public function getdsChuaXN(){
        $hopdong = hopdong::where('TrangThai',0)->join('chitiettour','chitiettour.MaCTTour','=','hopdong.MaCTTour')->join('tour','tour.MaTour','=','chitiettour.MaTour')->where('tour.MaNV',Auth::id())->get();
        return view('employee.qlHD.danhsach',['hopdong'=>$hopdong]);
    }
    public function getdsDaXN(){
        $hopdong = hopdong::where('TrangThai',1)->join('chitiettour','chitiettour.MaCTTour','=','hopdong.MaCTTour')->join('tour','tour.MaTour','=','chitiettour.MaTour')->where('tour.MaNV',Auth::id())->get();
        return view('employee.qlHD.danhsach',['hopdong'=>$hopdong]);
    }
    public function getdsDaHuy(){
        $hopdong = hopdong::where('TrangThai',2)->orwhere('TrangThai',3)->join('chitiettour','chitiettour.MaCTTour','=','hopdong.MaCTTour')->join('tour','tour.MaTour','=','chitiettour.MaTour')->where('tour.MaNV',Auth::id())->get();
        return view('employee.qlHD.danhsach',['hopdong'=>$hopdong]);
    }
    public function getListHDTour($MaCTTour){
        ...
        return view('employee.qlHD.ListHDTour',['hopdong'=>$hopdong], ['hopdong1'=>$hopdong1]);
    }
    ...
    public function postThanhToanHD(Request $request ){
            ...
            return  redirect()->back()->with('thongbao', 'Đã thanh toán Thành Công');
    ...
    public function postHuyBook($MaHD, $MaCTTour){
        ...
        if($hopdong->save() ){
                $chitiettour-> SoChoDaDat = hopdong::where('TrangThai', 1)-> sum('SoCho');
                $chitiettour -> save();
                return  redirect()->back()->with('thongbao', 'Bạn  Đã  Hủy Thành Công');
        }
        else{
