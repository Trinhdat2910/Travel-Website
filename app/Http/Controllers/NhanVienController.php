...
class NhanVienController extends Controller
{
    ...
    public function getDanhSachAD(){
        $user = user::where('level',3)->get();
        
        return view('admin.qlNV.danhsachAD',['user'=>$user]);
    }
    ...
    public function postThemNV(Request $request ){
     ...
     public function postThemAD(Request $request ){
        $this -> validate($request,
        [
            'TenNV' => 'required',
            'Email' => 'required|unique:users',
        ...
        $user -> save();
        return redirect()->back() -> with('thongbao', 'Tạo người quản trị mới Thành Công');
    }
