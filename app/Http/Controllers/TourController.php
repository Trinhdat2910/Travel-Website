...
class TourController extends Controller
{
    ...
    public function getthuchitour($MaCTTour){
        ...
        $thuchi= thuchi::where('MaCTTour',$MaCTTour)->get();
            ...
            return view('admin.qlTour.thuchitour',['thuchi'=>$thuchi],['MaCTTour'=>$MaCTTour] );
    ...
    public function getDSKhachDi($MaCTTour){
        ...
        return view('admin.qlTour.DSKhachDi',['hopdong'=>$hopdong], ['MaCTTour'=>$MaCTTour]);
    }
    ...
    public function getThucTrangDV($MaDVTour){
        ...
        return view('admin.qlTour.ThucTrangDV', ['dichvutour'=>$dichvutour] );
    ...
    public function postThemCTTour(Request $request, $MaTour ){
        ...
        if($request -> hasFile('LichTrinh'))
        {
            ...
            $Hinh = str_random(4)."_".$name;
            while(file_exists('upload/lichtrinh'.$Hinh))
            {
                $Hinh = str_random(4)."_".$name;
            }
            $file->move("upload/lichtrinh", $Hinh);
            $chitiettour -> LichTrinh= $Hinh;
        }
        else
        {
