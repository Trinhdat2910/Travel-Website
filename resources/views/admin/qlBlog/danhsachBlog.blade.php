                      ...
                      <tbody>
                        @foreach($blog as $b)
                          <tr>
                            ...
                            @if($b -> TrangThai == 0)
                            	<a class="hienthibtn btn-warning" data-id="{{$b -> MaBlog}}"> Đang Ẩn</a>
                            @else
                            	<a class="anbtn btn-success" style="color:#fff" data-id="{{$b -> MaBlog}}">Đang Hiển Thị</a>
                            @endif
                            ...
                            <td>
                            	<a class="editbtn btn btn-primary btn-fw"  style="color: white" href="admin/qlBlog/chitietBlog/{{$b -> MaBlog}}">Chi Tiết</a><br>
                              <a class="editbtn btn btn-dark btn-fw"  style="color: white" href="admin/qlBlog/suaBlog/{{$b -> MaBlog}}">
                          				Update</a><br>
  ...
  $(document).ready( function () {
    ...
    $('#dsblog').click(function(){
    	$('.deletebtn').click(function(){
            ...
            $('#Xoaform').attr('action','admin/qlBlog/XoaBlog/'+ $(this).data("id"));
    	});
    	$('.hienthibtn').click(function(){

    		$('#showModal').modal('show');
            
            $('#showform').attr('action','admin/qlBlog/showBlog/'+ $(this).data("id"));
    	});
    	$('.anbtn').click(function(){

    		$('#hideModal').modal('show');
            
            $('#hideform').attr('action','admin/qlBlog/hideBlog/'+ $(this).data("id"));
    	});
