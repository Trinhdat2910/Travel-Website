                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="admin/qlDoiTac/themDT" method="POST">
                    ...
                    <select class="form-control form-control-sm" id="exampleFormControlSelect3" name="loaidichvu">
                      @foreach(App\loaidoitac::where('MaLoaiDT','!=',3)->get() as $t)
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName2" placeholder="Số điện thoại" name="Tel" maxlength="11" onKeyPress="return isNumberKey(event)">
                    </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName3" placeholder="Số  Tài Khoản " name="STK" maxlength="14" onKeyPress="return isNumberKey(event)">
                  </div>
                  <div class="form-group">
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr><td><input type="text" class="form-control"  placeholder="Tên Dịch  Vụ " name="TenDV[]" required></td>'
        <td><input type="text" class="form-control" onKeyPress="return isNumberKey(event)" placeholder="Gía Người Lớn" name="GiaNL[]" required></td>
