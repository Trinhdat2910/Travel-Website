                        ...
                        @foreach($hopdong as $hd)
                          <tr>
                            ...
                            <td style="line-height: 20px">
                                 ...
                                 {{ $hd -> khachhang -> TenKH }}/ <br>({{ $hd -> khachhang -> Email }}) 
                            ...
                            <td style="line-height: 20px;">
                              ...
                              <a  class=" btn-rounded btn-success" style="color: #fff"> Đã Thanh Toán </a>
                               @else
                                <a  class="TTbtn1 btn-rounded btn-danger" style="color: #fff" data-mahd="{{ $hd -> MaHD }}" data-macttour="{{ $hd -> MaCTTour }}"  data-tentour="{{ $hd -> chitiettour -> tour -> TenTour }} ({{ $hd -> chitiettour -> tour -> MaTour }}-{{ $hd -> MaCTTour }})" data-tenkh="{{ $hd -> khachhang-> TenKH }}" data-con="{{ $hd -> ThanhTien - $hd -> DaThanhToan}}"  data-datt="{{ $hd -> DaThanhToan}}" > Chờ Thanh Toán</a>
                              @endif 
                              <br>
      ...
      <div class="modal-body">
       <form class="forms-sample"  method="POST" id="SuaTTKform" enctype="multipart/form-data">
                    ...
                    <div class="form-group" >
                      ...
                      <input type="text" class="form-control" id="Tel5" onKeyPress="return isNumberKey(event)" name='Tel' required maxlength="11">
                    </div>
                    <div class="form-group" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Passport5" onKeyPress="return isNumberKey(event)" name='Passport' maxlength="9">
                    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="forms-sample"  method="POST" id="ThemTTKform" enctype="multipart/form-data">
                    ...
                    <div class="form-group" >
                      <label for="exampleTextarea1">Tel</label>
                      <input type="text" class="form-control" id="Tel6" onKeyPress="return isNumberKey(event)" name='Tel' required maxlength="11">
                    </div>
                    <div class="form-group" >
                      <label for="exampleTextarea1">Địa Chỉ</label>
                    ...
                    <div class="form-group">
                      <label for="exampleTextarea1">Passport</label>
                      <input type="text" class="form-control" id="Passport6" onKeyPress="return isNumberKey(event)" name='Passport' maxlength="9">
                    </div>
