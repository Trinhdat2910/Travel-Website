                      ...
                      <tbody>
                        @foreach(App\dichvutour::where('MaCTTour',$chitiettour -> MaCTTour)->where('MaLoaiDT','3')->get() as $dvt)
                          <tr>
                            ...
                            <td>
                              <a class=" btn btn-secondary btn-fw" style="color: white;width: 150px; "  href="admin/qlTour/ThucTrangDV/{{ $dvt -> MaDVTour}}"> 
                                Thực Trạng DV</a>
                                <br>
  ...
  // });
    ...
    $('#delDVModal').modal('show');
      ...
      $('.addCBbtn').on('click',function(){
        ...
        $.get('admin/ajax/timcb/'+kh+'/'+dd+'/'+ngaybay, function(data){
          $('#bangCB').html(data);
        });
        });
    ...
    $('#addCBModal').modal('show');
      ...
      $('#suaCBform').attr('action','admin/qlTour/SuaCB/'+ $(this).data("id"));
      ...
      $('.TTCB').click(function(){
          ...
          $('#TT2form').attr('action','admin/qlTour/ThanhToanDV');
        $('#TT2Modal').modal('show');
      });
      $('.MailYC').click(function(){
        ...
        $('#MailYCform').attr('action','admin/qlBieuMau/MailYCDT');
