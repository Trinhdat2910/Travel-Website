                        ...
                        @foreach(App\chitiettour::where('MaTour',$t-> MaTour)->get() as $ct)
                          <tr>
                            <td  >
                              ...
                              <a href="admin/PDF/InLT/{{ $ct-> LichTrinh}}">In lịch trình tour </a>
                              @endif
                            ...
                            <td>
                              ...
                              @endif
                              <a href="admin/qlTour/DSKhachDi/{{$ct -> MaCTTour}}" class="btn btn-secondary btn-fw" style="width: 150px;" >List Lữ Khách</a>
                              <br>
                              <a href="admin/qlTour/chitiettour/{{$ct -> MaCTTour}}" ><button type="button" class="btn btn-primary btn-fw" style="width: 150px;">Dự Toán Chi Phí</button></a>
