                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="dshd">
                      ...
                      <tbody>
                        @foreach(App\hopdong::where('TrangThai',0)->join('chitiettour','chitiettour.MaCTTour','=','hopdong.MaCTTour')->join('tour','tour.MaTour','=','chitiettour.MaTour')->where('tour.MaNV',Auth::id())->get() as $hd)
                          <tr>
                            ...
                            <?php $daTT1 = $hd -> DaThanhToan; 
                              ...
                              ?>
                            @if($daTT1 == $tong1 )
                            <a class="btn btn-info btn-fw" href="employee/PDF/InHD/{{$hd -> MaHD}}" style="width: 170px;" target="_blank">In Hợp Đồng</a><br>
                            @else
                            ...
                            <a class="huybook btn btn-danger btn-fw" data-id="{{$hd -> MaHD}}" style="width: 170px; color:#fff">Hủy Booking</a><br>
                            ...
                            <a class="btn btn-danger btn-fw" href="employee/qlHD/xoaHD/{{$hd -> MaHD}}" style="width: 170px;">Xóa Booking</a>
  ...
  $(document).ready( function () {
    ...
    $('#dshd').click(function(){
      ...
      $('.TTbtn1').click(function(){
          ...
          $('#TT1form').attr('action','employee/qlHD/ThanhToanHD');
        $('#TT1Modal').modal('show');
      });
      $('.XacNhanbtn').click(function(){
          ...
          $('#XNform').attr('action','employee/qlHD/XacNhanHD');
        $('#XNModal').modal('show');
      });
      ...
      $('.huybook').click(function (){
        ...
        $('#HuyBooKform').attr('action','employee/qlHD/HuyBook/'+ $(this).data("id"));
      });
      $('.suabook').click(function (){
        ...
        $('#SuaBookform').attr('action','employee/qlHD/SuaBook/'+ $(this).data("id"));
      });
      
    });
    $('.dslk').click(function (){
        var mahd= $(this).data("id");
        $.get('employee/ajax/dskhach/'+ mahd  , function(data){
          $('#dlkh').html(data);
          $('.SuaTTK').click(function (){
            ...
            $('#SuaTTKform').attr('action','employee/qlHD/SuaTTK/'+ $(this).data("id"));
          });
            $('.ThemTTK').click(function (){
             
             
            $('#ThemTTKModal').modal('show');
            $('#ThemTTKform').attr('action','employee/qlHD/ThemTTK/'+ $(this).data("id"));
          });
            $('.XoaTTK').click(function (){
             
             document.getElementById('tenhk').innerHTML= $(this).data("hoten");
            $('#XoaTTKModal').modal('show');
            $('#XoaTTKform').attr('action','employee/qlHD/XoaTTK/'+ $(this).data("id"));
          });
