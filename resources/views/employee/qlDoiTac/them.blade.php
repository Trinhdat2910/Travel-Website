...
<div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName2" placeholder="Số điện thoại" name="Tel" maxlength="11">
                    </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName3" placeholder="Số  Tài Khoản " name="STK" maxlength="14">
                  </div>
                  <div class="form-group">
