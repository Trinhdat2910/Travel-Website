      ...
      <div class="modal-body">
        ...
        <form class="forms-sample" action="employee/qlNV/themDH" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputCity7" placeholder="Số điện thoại" name='Tel' maxlength="11">
                    </div>
      ...
      <div class="modal-body">
        ...
        <form class="forms-sample" action="employee/qlNV/suaNV" method="POST" id="editform" enctype = "multipart/form-data">
                   ...
                   <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    ...
                    <div class="form-group">
                      <label for="exampleInputCity1">Số điện thoại</label>
                      <input type="text" class="form-control" id="ftel" placeholder="Số điện thoại" name='Telnv' maxlength="11">
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Địa Chỉ</label>
