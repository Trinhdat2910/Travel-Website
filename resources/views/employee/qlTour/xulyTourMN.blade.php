...
<div class="card">
                <div class="card-body">
                  ...
                  @foreach(App\tour::where('MaKV',3)->where('MaNV', Auth::id())->get() as $t)
                        ...
                        @foreach(App\chitiettour::where('MaTour',$t-> MaTour)->get() as $ct)
                          <tr>
                            ...
                            <td>
                              ...
                              <br>
                              <a href="employee/qlTour/chitiettour/{{$ct -> MaCTTour}}" ><button type="button" class="btn btn-primary btn-fw" style="width: 150px;">Dự Toán Chi Phí</button></a>
