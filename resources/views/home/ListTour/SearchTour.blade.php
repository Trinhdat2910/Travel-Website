      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2 class="font-weight-light text-black">Kết Quả Tìm Kiếm</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-center">
            <a href="home/ListTour/ListBlog" class="btn btn-outline-primary border-2 py-3 px-5">Xem Tát Cả Bài Viết</a>
          </div>
        </div>
      </div>
    </div>
