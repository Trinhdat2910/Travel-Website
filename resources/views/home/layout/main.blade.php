...
@section('contentHome')
    <div class="slide-one-item home-slider owl-carousel">
      @foreach(App\tour::where('NoiBat', 1)->inRandomOrder()->limit(10)->get() as $t)
    ...
    <div class="site-section">
      ...
      <div class="container overlap-section">
        <div class="row">
          @foreach(App\tour::where('MaKV',1)->inRandomOrder() ->limit(1)->get(); as $t)
          ...
          @endforeach
          @foreach(App\tour::where('MaKV',2)->inRandomOrder() ->limit(1)->get(); as $t)
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          ...
          @endforeach
          @foreach(App\tour::where('MaKV',3)->inRandomOrder() ->limit(1)->get(); as $t)
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7">
            <h2 class="font-weight-light text-black text-center">Kinh Nghiệm Du Lịch</h2>
          </div>
        </div>

        <div class="nonloop-block-13 owl-carousel">
          @foreach(App\blog::where('TrangThai', 1) ->inRandomOrder()->limit(4)-> get() as $b)
          <div class="item">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 mb-5">
                  <img src="upload/blog/{{  $b -> HinhAnh}}" alt="Image" class="img-md-fluid">
                </div>
                <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
                  <h5>{{  $b -> TieuDe}}</h5>
                  <p class="text-black lead">&ldquo;{{  $b -> TomTat}}&rdquo;</p>
                  <p class="">&mdash; <em>{{  $b -> user -> TenNV}}</em>, <a href="#">Traveler</a></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            ...
            <p class="color-black-opacity-5">Hãy Chọ Điểm Đến Tiếp Theo Của Bạn</p>
          </div>
        </div>
        <div class="row">
          @foreach(App\tour::where('TinhTrang',1)->inRandomOrder()->limit(12)->get() as $t)
        ...
        <div class="row mb-3 align-items-stretch">
          ...
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <h2 class="font-size-regular"><a href="home/ListTour/DetailBlog/{{$b1 -> MaBlog}}">{{ $b1-> TieuDe }}</a></h2>
